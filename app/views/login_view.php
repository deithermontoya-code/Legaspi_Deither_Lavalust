...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        p.subtitle { margin-bottom: 34px; color: var(--muted); }
        label { display: block; margin: 20px 0 7px; font: 700 .78rem Arial, sans-serif; letter-spacing: .04em; text-transform: uppercase; }
        ...
        button { width: 100%; margin-top: 30px; padding: 15px 18px; border: 0; background: var(--orange); color: #fff; cursor: pointer; font: 700 .82rem Arial, sans-serif; letter-spacing: .08em; text-transform: uppercase; }
        button:hover { background: #cf6030; }
        .msg { padding: 12px 14px; margin-bottom: 18px; border-left: 3px solid; font: .85rem Arial, sans-serif; }
        .msg.error { border-color: #b42318; background: #fff0ed; color: #8a1c13; }
        .msg.info { border-color: #287a77; background: #e8f5f1; color: #17605d; }
        ...
        @media (max-width: 720px) { body { padding: 0; } .auth-shell { display: block; min-height: 100vh; } .brand-panel { min-height: 280px; } .mark { margin-bottom: 28px; } .brand-foot { margin-top: 44px; } .form-panel { min-height: 520px; } }
    </style>
</head>
<body>
<div class="auth-shell">
<section class="brand-panel">
    <div><div class="mark">PD</div><p class="eyebrow">Product Desk</p><h1>Make room for better stock.</h1><p class="brand-copy">A focused workspace for the products your team keeps moving.</p></div>
